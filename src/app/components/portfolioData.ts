...
export const DATA: Record<Lang, LangData> = {
  ru: {
    ...
    cv: {
      ...
      summary: 'Создающий B2B- и B2C-продукты в сфере информационной безопасности, где ясность, структура и главный пользовательский опыт имеют ключевое значение. Проектирую интуитивно понятные интерфейсы с продуманными пользовательскими сценариями, четкой логикой и выверенным визуальным стилем, который делает сложные продукты простыми и удобными. Тесно сотрудничаю с продакт-менеджерами, разработчиками и аналитиками на всех этапах создания продукта.',
      ...
      contactRows: [
        ...
        { label: 'портфолио', value: 'Портфолио', href: 'https://annarubanenko.github.io/portfolio/' },
      ],
      highlights: [
        'B2B / B2C / information security',
        'end-to-end UX: flows, wireframes, prototypes',
        'дизайн-системы, Storybook, кастомные компоненты',
        'дашборды, формы, фильтры, таблицы и сложный UI',
      ],
      ...
      experience: [
        {
          ...
          details: [
            'Проектировала высоконагруженные системы и интерфейсы для B2B-продуктов в сфере информационной безопасности.',
            'Работая над полным пользовательским опытом end-to-end: от user flows и wireframes до high-fidelity прототипов.',
            'Создавала и поддерживала дизайн-систему; работала со Storybook, участвовала в миграции на Taiga UI, проектировала кастомные компоненты.',
            'Тесно сотрудничала с разработчиками, продакт-менеджерами и аналитиками на каждом этапе процесса.',
            'Возглавляла редизайн и UX-улучшения в экосистеме веб-приложения: дашборды, формы, фильтры, таблицы и другие UI-компоненты.',
          ],
        },
        {
          role: 'UX / UI Designer',
          ...
          details: [
            'Создавала wireframes, mockups и интерактивные прототипы для презентации идей как команде разработки, так и стейкхолдерам.',
            'Проектировала адаптивные интерфейсы; руководила редизайнами и улучшала пользовательские сценарии.',
            'Поддерживала и обновляла дизайн-системы и UI-киты, обеспечивая консистентность между продуктами.',
            'Проводила usability testing и собирала обратную связь для улучшения пользовательского опыта и эффективности интерфейсов.',
          ],
        },
      ],
      ...
      softSkills: ['Любознательность', 'Фасилитация', 'Переговоры', 'Приоритизация', 'Решение проблем', 'Стратегическое мышление', 'Эмпатия', 'Навыки презентации'],
      hardSkillsTitle: 'хард скиллс',
      hardSkills: [
        { title: 'Product Strategy: бизнес-цели, roadmap', description: '' },
        { title: 'UX Research: интервью, анализ данных', description: '' },
        { title: 'UI Design: продуманные интерфейсы', description: '' },
        { title: 'Design Systems: консистентность', description: '' },
        { title: 'Prototyping: интерактивные концепции', description: '' },
        { title: 'User Flows: пользовательские сценарии', description: '' },
        { title: 'Information Architecture — четкая структура', description: '' },
        { title: 'Usability Testing — валидация решений', description: '' },
        { title: 'Data Analysis — метрики, оптимизация', description: '' },
      ],
    ...
    projects: [
      {
        ...
        slides: [
          ...
          { image: '/portfolio/scan-launch-4.png', cover: 'kanban', caption: '4 / ЕСЛИ СКАНИРОВАНИЕ МОЖНО ОСТАНОВИТЬ ПОСЛЕ ЗАПУСКА: после нажатия кнопка переходит в состояние «Идет сканирование» с иконкой загрузки. форма остаётся видимой, пользователь понимает: процесс запущен' },
          { image: '/portfolio/scan-launch-5.png', cover: 'chat', caption: '5 / ЕСЛИ СКАНИРОВАНИЕ НЕЛЬЗЯ ОСТАНОВИТЬ ПОСЛЕ ЗАПУСКА: поверх формы появляется оверлей со спиннером и текстом «Сканирование». поля недоступны для редактирования - это предотвращает случайные изменения во время работы в таблице — со статусом, фильтрами и прямой ссылкой на отчёт.' },
      ...
      },
      {
        ...
        process: 'поиск решения шёл от статичного overview к модульной модели: сначала собирали список метрик по ролям, затем проверяли варианты виджетов, порядок добавления, превью до применения и сценарий разворачивания важных блоков.\n\n<em>AI</em> использовался для кластеризации потребностей разных ролей, генерации гипотез по составу виджетов и быстрой проверки информационной архитектуры. финальная композиция собиралась вокруг реальных ежедневных задач: мониторинг, сравнение, приоритизация и быстрый переход к деталям.',
      ...
      },
      {
        ...
        process: 'поиск решения строился вокруг скорости и контроля: сравнивали inline-редактирование, отдельную страницу и компактную модалку. итерации помогли оставить пользователя в контексте карточки, но дать достаточно места для статуса, уровня, влияния и подтверждения.\n\n<em>AI</em> применялся для разборки сценариев аналитика, проверки последовательности полей, формулировки ошибок и подтверждений, а также для быстрого сравнения вариантов UX-copy. после этого сценарий уточнялся через ограничения данных и привычные паттерны работы аналитиков.',
  ...
  en: {
    ...
    cv: {
      ...
      photoSrc: '/portfolio/profile-binary-source.png',
      headline: 'Product & UX/UI designer',
      summary: 'Product designer creating B2B and B2C products in the information security space, where clarity, structure, and smooth user experience matter most. I design intuitive interfaces with thoughtful user flows, clear logic, and a polished visual style that makes complex products feel simple. I work closely with PMs, developers, and analysts throughout the product process, from concept to launch, keeping teams aligned and focused on meaningful outcomes.',
      availability: 'I genuinely love what I do.',
      ...
      contactRows: [
        ...
        { label: 'email', value: 'aneyta@mail.ru', href: 'mailto:aneyta@mail.ru' },
        { label: 'telegram', value: 't.me/annademeshko', href: 'https://t.me/annademeshko' },
        { label: 'portfolio', value: 'Portfolio', href: 'https://annarubanenko.github.io/portfolio/' },
      ],
      highlights: [
        'B2B / B2C / information security',
        'end-to-end UX from flows to prototypes',
        'design systems, Storybook, and custom components',
        'dashboards, forms, filters, tables, and complex UI',
      ],
      ...
      experience: [
        {
          ...
          details: [
            'Designed high-load systems and interfaces for B2B products in the information security domain',
            'Worked on end-to-end user experience: from user flows and wireframes to high-fidelity prototypes',
            'Built and maintained a design system; worked with Storybook, contributed to migration to Taiga UI, and designed custom components',
            'Collaborated closely with product managers, developers, and analysts at every stage of the process',
            'Led redesign and UX improvements across a web application ecosystem: dashboards, forms, filters, tables, and other UI components',
          ],
        },
        {
          role: 'UX / UI Designer',
          ...
          details: [
            'Created wireframes, mockups, and interactive prototypes to communicate ideas to both the development team and stakeholders',
            'Designed responsive interfaces; led redesigns and improved user journeys',
            'Maintained and updated design systems and UI kits to ensure consistency across products',
            'Conducted usability testing and gathered feedback to improve user experience and interface performance',
            'Managed multiple projects simultaneously, balancing timelines and quality',
          ],
        },
      ],
      ...
      education: [
        ...
        { title: 'Master’s in Information Security Analytics', place: 'ITMO University', period: 'Sep 2020 – Jun 2022' },
        { title: 'Bachelor’s in Computational Linguistics', place: 'SUAI', period: 'Sep 2014 – Jun 2018' },
      ],
      toolsTitle: 'tools',
      softSkillsTitle: 'soft skills',
      softSkills: ['Curiosity', 'Facilitation', 'Negotiation', 'Prioritization', 'Critical thinking', 'Problem-solving', 'Strategic thinking', 'Empathy', 'Presentation skills'],
      hardSkillsTitle: 'hard skills',
      hardSkills: [
        { title: 'Product Strategy — business goals, roadmap', description: '' },
        { title: 'UX Research — user insights, interviews', description: '' },
        { title: 'UI Design — polished interfaces', description: '' },
        { title: 'Design Systems — scalable consistency', description: '' },
        { title: 'Prototyping — interactive concepts', description: '' },
        { title: 'User Flows — seamless journeys', description: '' },
        { title: 'Information Architecture — clear structure', description: '' },
        { title: 'Usability Testing — validate decisions', description: '' },
        { title: 'Data Analysis — metrics, optimization', description: '' },
      ],
    ...
    projects: [
      {
        ...
        slides: [
          ...
          { image: '/portfolio/scan-launch-4.png', cover: 'kanban', caption: '4 / IF THE SCAN CAN BE STOPPED AFTER LAUNCH: after clicking, the button enters "Scanning" state with a loading icon. the form stays visible — the user understands the process is running' },
          { image: '/portfolio/scan-launch-5.png', cover: 'chat', caption: '5 / IF THE SCAN CANNOT BE STOPPED AFTER LAUNCH: an overlay with a spinner and "Scanning" text appears on top of the form. fields are locked to prevent accidental changes. the table shows status, filters, and a direct link to the report' },
      ...
      },
      {
        ...
        process: 'solution search went through several iterations: first a simple change log, then a split-view for two scans, then a component table with deltas and a details side panel.\n\n<em>AI</em> helped speed up research and interface thinking: i used it to structure auditor scenarios, shape hypotheses for diff logic, compare data-grouping options, and stress-test UX copy for "new / fixed / changed" states. final decisions were still grounded in product logic, data constraints, and team review.',
      ...
      },
      {
        ...
        process: 'solution search moved from a static overview toward a modular model: first we mapped metrics by role, then tested widget options, add flow, preview-before-apply behavior, and expanded states for important blocks.\n\n<em>AI</em> helped cluster role needs, generate hypotheses for widget composition, and quickly check information architecture. the final layout was grounded in daily jobs: monitoring, comparison, prioritization, and fast access to details.',
