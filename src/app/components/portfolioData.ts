    ...
    projects: [
      {
        ...
        cover: 'table',
        slides: [
          { image: '/My_site/scan-launch-1.png', cover: 'table', caption: '1 / the user is on the app page with their scan history. from the context menu, they pick “Scan.” the menu also gives them quick access to other actions like checking the SBOM, manifest, and archive, plus managing notification settings—all in one place.' },
          { image: '/My_site/scan-launch-2.png', cover: 'diff', caption: '2 / form: engineer selects a version and scanner config, the CTA unlocks, params are validated on the fly.' },
          { image: '/My_site/scan-launch-3.png', cover: 'steps', caption: '3 / progress: live job status after launch — queued → running → done with a timestamp.' },
          { image: '/My_site/scan-launch-4.png', cover: 'kanban', caption: '4 / guard: while the job is running, a blocking overlay prevents re-submitting and creating a duplicate.' },
          { image: '/My_site/scan-launch-5.png', cover: 'chat', caption: '5 / result: the completed scan lands in the table — with status, filters and a direct link to the report.' },
          { image: '/My_site/scan-launch-6.png', cover: 'table', caption: '6 / details: expanded scan card with metadata, logs and completion status.' },
        ],
      ...
      },
      {
        ...
        cover: 'diff',
        slides: [
          { image: '/My_site/scan-launch-1.png', cover: 'table', caption: '1 / users select two scans by checking boxes in the table. when rows 5 and 2 are checked —> the interface enables the "Comparison" button. the table shows key attributes: environment, launch method, violation count, and status' },
